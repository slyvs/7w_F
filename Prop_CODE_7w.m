...
SimMod.Scan_mode = 'Propagation_Z';
...
SimMod.Scan_cond = 'Propagate'; 
                 ...
                 % 'Invalid Condition'
SimMod.Wlofs_num =    0+1; % number of center wavelength offset, default: 200+1
SimMod.WlSep_num =    0+1; % number of pump pump wavelength separation, default: 210+1
SimMod.Power_num =   14+1; % number of pump/signal power, 250+1
...
switch SimMod.Wave_mode 
  case '3W1P'  
    if SimMod.Power_num == 1,
      Exc.Pwr(:,1) = 1.0e-6;  % W, Initial power of Pump1  (P1), non-degenerate
      Exc.Pwr(:,2) = 1.0e-6;  % W, Initial power of Pump2  (P2), non-degenerate
      Exc.Pwr(:,3) = 100e-3;  % W, Initial power of Signal0(S0), degenerate signal & Idler 
